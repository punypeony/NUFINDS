        ...
        <div class="lookup-form">
            ...
            <form action="TrackReport.php" method="post" style="display:flex; gap:0.5rem; flex-wrap:wrap; align-items:center;">
                <input type="text" name="StudentNumber"
                       placeholder="Enter Student Number (e.g., 2024-1001234)"
                       required
                       style="flex:1; min-width:250px; padding:0.75rem; border:1px solid #ccc; border-radius:8px;">
                <button type="submit"
                        style="padding:0.75rem 1.5rem; background:#1f7a8c; color:white; border:none; border-radius:8px; cursor:pointer;">
                    Search
                </button>
            </form>
        </div>
